...
import Astronaut from '@/assets/images/homePage/astronaut.png'
...
export default {
  ...
  data() {
    return {
      ...
      data: {},
      Banner: Banner,
      columns: Array.from({ length: 4 }, (v, k) => require('@/assets/images/homePage/column/' + (k + 1) + '.png')),
      Astronaut: Astronaut,
      Setting: Setting
    }
  },
...
#home
  wh(100vw, 100vh)
  bg('../assets/images/homePage/bg.png')
